...
HD_PWD='/home/mdescham/Bureau/BE_Controleur_Ethernet/Ethernet10/Ethernet10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Controleur_Ethernet.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Controleur_Ethernet.tcl -notrace
